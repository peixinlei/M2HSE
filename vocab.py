...
annotations = {
    'corel5k_precomp': ['train_caps.txt', 'dev_caps.txt'],
    'pascal_precomp': ['train_caps.txt', 'dev_caps.txt'],
}
...
def main(data_path, data_name):
    vocab = build_vocab(data_path, data_name, caption_file=annotations, threshold=2)
